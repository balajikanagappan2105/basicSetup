...
@Component({
  selector: 'app-email-data-entry',
  templateUrl: './email-data-entry.component.html',
  styleUrls: ['./email-data-entry.component.scss'],
	providers: [ConfirmationService, ForgotPasswordService, TranslatePipe]
})
export class EmailDataEntryComponent implements OnInit {
	...
	showMobileDataEntry()
	{
	this.router.navigate(['mobiledataentry'])
