...
@Component({
  selector: 'app-language-preference-entry',
  templateUrl: './language-preference-entry.component.html',
  styleUrls: ['./language-preference-entry.component.scss'],
	providers: [ConfirmationService, ForgotPasswordService, TranslatePipe]
})
export class LanguagePreferenceEntryComponent implements OnInit {
